...
--Create character race table
CREATE TABLE Character_Race (
    ID INT DEFAULT 0 NOT NULL PRIMARY KEY,
    Negation FLOAT NOT NULL DEFAULT 0.0,
    Durability FLOAT DEFAULT 0.0 NOT NULL,
    Name VARCHAR(50) NOT NULL,
...
CREATE TABLE Player_Character(
    ...
    FOREIGN KEY (Is_Race_ID) REFERENCES Charachter_Race(ID) ON DELETE SET NULL
);
